      ...
      fluidRow(
        column(6,
          div(class = "panel-glass", style = "padding: 30px; height: 100%; display: flex; flex-direction: column; justify-content: space-between; border-radius: 12px;",
            ...
            div(style = "margin-top: 20px;",
              downloadButton("download_tomo1_home", trans("Descargar Tomo I (PDF)", "Download Volume I (PDF)"), 
        ...
        column(6,
          div(class = "panel-glass", style = "padding: 30px; height: 100%; display: flex; flex-direction: column; justify-content: space-between; border-radius: 12px;",
            ...
            div(style = "margin-top: 20px;",
              downloadButton("download_tomo2_home", trans("Descargar Tomo II (PDF)", "Download Volume II (PDF)"), 
                             class = "btn-success btn-lg", style = "width: 100%; font-weight: bold;")
            )
          )
        )
